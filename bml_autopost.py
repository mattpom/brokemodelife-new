...
if site["credit"]:
    credit_rule = "End with the site URL " + site["credit"] + " woven naturally into the post as part of a sentence. NEVER write 'from our friends at' or any variation."
else:
    credit_rule = "No external site credit needed."

prompt = ("Write one X post for @brokemode. Site: " + site["name"] + " covering " + site["focus"] + ". "
    "Rules: max 260 chars total. Sharp direct real voice. Budget mindset always. 1-2 hashtags max. "
    + credit_rule + " Return ONLY the post text. No quotes, no labels, no explanation.")
...
# Fix cut-off first characters: strip leading non-word non-emoji chars
